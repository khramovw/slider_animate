            ...
            slideAll.forEach(function (sl, d, i) {
                        ...
                        if (sl.dataset.slide == data.from) {
                                    ...
                                    if (data.from == 4) {
                                                ...
                                                tl.to(sl.childNodes[3].childNodes[3], 0.3, { top: "54%", left: "24%", width: "40%", ease: Power4.easeOut }).to(sl.childNodes[3].childNodes[3], 0.1, { autoAlpha: 0 }).to(sl, 0, { autoAlpha: 0, ease: Power4.easeOut }, '-=0.3');
                        ...
                        if (sl.dataset.slide == data.to) {
                                    ...
                                    if (data.to == 4) {
                                                ...
                                                tl.to(sl, 0, { autoAlpha: 1, ease: Power4.easeOut }, '-=0.3').to(sl.childNodes[3].childNodes[3], 0.1, { autoAlpha: 1 }, "-=0.5").to(sl.childNodes[3].childNodes[3], 0.3, { top: "10%", left: "-28%", width: "100%", ease: Power4.easeOut });
